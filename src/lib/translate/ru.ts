...
export const ruDict: Dictionary = {
  ...
  'transactions.geolocation': 'Геопозиция',
  'transactions.detect_geolocation': 'Определить по GPS',
  'transactions.open_geolocation': 'Открыть на карте',
  'transactions.geolocation_not_supported': 'Геолокация не поддерживается на этом устройстве',
  'transactions.geolocation_failed': 'Не удалось получить геолокацию',
  ...
  'transactions.description': 'Описание из банковской выписки',
  'transactions.verification.ok': 'Совпадает с выпиской {statement}',
  'transactions.verification.mismatch': 'Отличается от выписки {statement}.',
  'transactions.verification.missing': 'Не найдена в выписке {statement}',
  'transactions.verification.expected': 'В банке: {date}, {amount}',
  ...
  'import_export.repeatings': 'Повторения',
  ...
  'settings.api_tokens': 'API токены',
  'api_tokens.title': 'API токены',
  'api_tokens.description':
    'Токены дают полный доступ к данным через API. Используйте их для скриптов и внешних инструментов. Токен текущего устройства отозвать здесь нельзя.',
  'api_tokens.active_tokens': 'Активные токены',
  'api_tokens.no_tokens': 'Токенов нет',
  'api_tokens.guest_mode': 'API токены доступны только зарегистрированным пользователям',
  'api_tokens.created_at': 'Создан {date}',
  'api_tokens.current': 'это устройство',
  'api_tokens.create': 'Создать токен',
  'api_tokens.create_failure': 'Не удалось создать токен',
  'api_tokens.load_failure': 'Не удалось загрузить токены',
  'api_tokens.new_token': 'Новый токен',
  'api_tokens.new_token_hint': 'Скопируйте токен сейчас, больше он показан не будет.',
  'api_tokens.copy': 'Скопировать',
  'api_tokens.copied': 'Токен скопирован',
  'api_tokens.copy_failure': 'Не удалось скопировать токен',
  'api_tokens.revoke': 'Отозвать',
  'api_tokens.revoke_confirm': 'Отозвать токен {id}…? Скрипты и устройства, использующие его, потеряют доступ.',
  'api_tokens.revoke_success': 'Токен отозван',
  'api_tokens.revoke_failure': 'Не удалось отозвать токен',
  'api_tokens.usage': 'Использование',
  'api_tokens.usage_hint': 'Передавайте токен в заголовке Authorization. Снепшот всех данных доступен по адресу:',
