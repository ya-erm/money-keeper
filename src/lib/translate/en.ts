...
export const enDict: Dictionary = {
  ...
  'analytics.categories.comments': 'By comment',
  'analytics.categories.no_comment': 'No comment',
  ...
  'transactions.geolocation': 'Geolocation',
  'transactions.detect_geolocation': 'Detect via GPS',
  'transactions.open_geolocation': 'Open on map',
  'transactions.geolocation_not_supported': 'Geolocation is not supported by this device',
  'transactions.geolocation_failed': 'Failed to get geolocation',
  ...
  'transactions.description': 'Description from bank statement',
  'transactions.verification.ok': 'Matches the bank statement {statement}',
  'transactions.verification.mismatch': 'Differs from the bank statement {statement}.',
  'transactions.verification.missing': 'Not found in the bank statement {statement}',
  'transactions.verification.expected': 'In the bank: {date}, {amount}',
  ...
  'import_export.repeatings': 'Repeatings',
  ...
  'import_export.journal': 'Journal',
  'import_export.journal_records': 'Journal items on the server: {count}, sync number: {syncNumber}',
  'import_export.journal_load_failure': 'Failed to load journal info',
  'import_export.compact': 'Compact journal',
  'import_export.compact_description':
    'The server stores every change as a journal item. Compaction replaces the whole history with a single snapshot of the current state, other devices pick it up on the next sync.',
  'import_export.compact_confirm':
    'The change history on the server will be replaced with the current state and can not be restored. Continue?',
  'import_export.compact_success': 'Journal compacted: {before} → {after} items',
  'import_export.compact_failure': 'Failed to compact journal',
  'import_export.compact_conflict': 'The journal has changed, sync and try again',
  'import_export.compact_queue_not_empty': 'Some changes are not uploaded yet, try again later',
  // Settings
  ...
  'api_tokens.description':
    'Tokens give full access to your data through the API. Use them for scripts and external tools. The token of the current device can not be revoked here.',
  'api_tokens.active_tokens': 'Active tokens',
  'api_tokens.no_tokens': 'No tokens',
  'api_tokens.guest_mode': 'API tokens are available only for registered users',
  'api_tokens.created_at': 'Created {date}',
  'api_tokens.current': 'this device',
  'api_tokens.create': 'Create token',
  'api_tokens.create_failure': 'Failed to create token',
  'api_tokens.load_failure': 'Failed to load tokens',
  'api_tokens.new_token': 'New token',
  'api_tokens.new_token_hint': 'Copy the token now, it will not be shown again.',
  'api_tokens.copy': 'Copy',
  'api_tokens.copied': 'Token copied',
  'api_tokens.copy_failure': 'Failed to copy token',
  'api_tokens.revoke': 'Revoke',
  'api_tokens.revoke_confirm': 'Revoke token {id}…? Scripts and devices using it will lose access.',
  'api_tokens.revoke_success': 'Token revoked',
  'api_tokens.revoke_failure': 'Failed to revoke token',
  'api_tokens.usage': 'Usage',
  'api_tokens.usage_hint': 'Pass the token in the Authorization header. Snapshot of all data is available at:',
